...
NSString *const FMDBLogNotification                = @"FMDBLogNotification";
NSString *const FMDBLogNotificationKeyLogLevel     = @"FMDBLogNotificationLogLevel";
NSString *const FMDBLogNotificationKeyMessage      = @"FMDBLogNotificationMessage";
...
- (void)postLogNotification:(NSString *)message line:(NSInteger)line function:(const char *)function logLevel:(FMDBLogLevel)level {
    NSDictionary *dic = @{FMDBLogNotificationKeyLogLevel: @(level)
                          , FMDBLogNotificationKeyFunctionName: [NSString stringWithFormat:@"%s", function]
                          , FMDBLogNotificationKeyLine: @(line)
                          , FMDBLogNotificationKeyMessage: message
                          };
    
    [[NSNotificationCenter defaultCenter] postNotificationName:FMDBLogNotification object:dic];
}
